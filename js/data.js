...
const MONTHS = [
  // ===================== 0–2 months: exposure ============================
  {
    ...
    words: [
      ...
      { w: 'Hello', c: 'Social', ipa: '/həˈləʊ/', say: 'huh-LOH', focus: 'h', why: 'Said dozens of times a day, so repetition comes free.', acts: ['Say "hello" then wait 3 seconds, holding eye contact, as if they might reply.', 'Use it every single time you re-enter their view.'] },
      ...
      { w: 'Song', c: 'Play', ipa: '/sɒŋ/', say: 'SONG', focus: 'ng', why: 'Melody is how babies first parse language — rhythm before words.', acts: ['Say "song time!" then sing the same lullaby daily.', 'Let them feel your chest vibrate as you hum.'] },
    ],
  },
  {
    m: 1,
    ...
    words: [
      ...
      { w: 'Nose', c: 'Body', ipa: '/nəʊz/', say: 'NOHZ', focus: 'n', why: 'Face parts are close, high-contrast and always available.', acts: ['Boop their nose each time you say it.', 'Point to your own nose, then theirs.'] },
      ...
      { w: 'Warm', c: 'Feelings', ipa: '/wɔːm/', say: 'WAWM', focus: 'w', why: 'The rounded "w" lip shape is very visible up close.', acts: ['During a cuddle: "warm — you\'re nice and warm".', 'Exaggerate the lip pucker so they can watch it.'] },
      ...
      { w: 'Home', c: 'World', ipa: '/həʊm/', say: 'HOHM', focus: 'h', why: 'A word for the safe place, said constantly on the way back from anywhere.', acts: ['Coming through the door: "we\'re home!"', 'Use the same sing-song each time.'] },
      { w: 'Rock', c: 'Action', ipa: '/rɒk/', say: 'ROK', focus: 'r', why: 'Pairs a word to a physical rhythm they feel in the body.', acts: ['Rock them and chant "rock… rock… rock" on the beat.', 'Slow the rhythm as they settle.'] },
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Yes', c: 'Social', ipa: '/jes/', say: 'YES', focus: 'y', why: 'A warm confirmation word to close every exchange.', acts: ['Answer every coo with "yes! Tell me more."', 'Nod as you say it.'] },
    ],
  },
  ...
  // ===================== 3–5 months: turn-taking ==========================
  {
    ...
    words: [
      ...
      { w: 'Water', c: 'Routine', ipa: '/ˈwɔː.tə/', say: 'WAW-ter', focus: 'w', why: 'Bath time is multi-sensory, which makes words stickier.', acts: ['Splash gently: "water! Warm water."', 'Pour it over their hands and name it.'] },
      ...
      { w: 'Bath', c: 'Routine', ipa: '/bɑːθ/', say: 'BATH', focus: 'b', why: 'A daily, predictable event worth naming in advance.', acts: ['Say "bath time!" as the water runs.', 'Same phrase, same tune, every night.'] },
    ],
  },
  {
    m: 4,
    ...
    words: [
      ...
      { w: 'Soft', c: 'Concepts', ipa: '/sɒft/', say: 'SOFT', focus: 's', why: 'Texture words pair a sound with something they can feel.', acts: ['Stroke a blanket on their cheek: "soft".', 'Contrast with something hard.'] },
      { w: 'Teddy', c: 'Toys', ipa: '/ˈted.i/', say: 'TED-ee', focus: 't', why: 'A beloved object becomes an emotionally loaded word.', acts: ['"Here\'s teddy. Teddy is soft."', 'Have teddy "walk" up to them and say hello.'] },
      ...
      { w: 'Gentle', c: 'Manners', ipa: '/ˈdʒen.təl/', say: 'JEN-tul', focus: 'j', why: 'Starts the vocabulary of careful touch early.', acts: ['Stroke your own arm with their hand: "gentle".', 'Use the word every time they touch a face or pet.'] },
    ],
  },
  {
    m: 5,
    ...
    words: [
      { w: 'Banana', c: 'Food', ipa: '/bəˈnɑː.nə/', say: 'buh-NAH-nuh', focus: 'b', why: 'Three syllables with a lovely repeated "n" in the middle.', acts: ['Show it at mealtime: "banana — na-na-na".', 'Let them hold and squash it while you name it.'] },
      ...
      { w: 'Hot', c: 'Concepts', ipa: '/hɒt/', say: 'HOT', focus: 'h', why: 'An early safety word tied to real sensation.', acts: ['Near warm food: "hot — careful, hot" with a cautious face.', 'Let them feel a safely warm mug.'] },
      { w: 'Cold', c: 'Concepts', ipa: '/kəʊld/', say: 'KOHLD', focus: 'k', why: 'The contrast that makes "hot" meaningful.', acts: ['Touch something from the fridge: "cold! Brrr."', 'Say "hot… cold" back to back.'] },
  ...
  // ===================== 6–8 months: babbling ============================
  {
    ...
    words: [
      ...
      { w: 'Dog', c: 'Animals', ipa: '/dɒɡ/', say: 'DOG', focus: 'd', why: 'High-frequency, easy to spot on any walk.', acts: ['"Dog! Woof woof."', 'Point out every dog you pass and name it.'] },
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Bird', c: 'Animals', ipa: '/bɜːd/', say: 'BURD', focus: 'b', why: 'Extends attention out of the room and through the window.', acts: ['At the window: "bird! Tweet tweet."', 'Track one together and narrate its flight.'] },
      ...
      { w: 'Horse', c: 'Animals', ipa: '/hɔːs/', say: 'HAWSS', focus: 'h', why: 'Breathy "h" start plus a fun clip-clop rhythm.', acts: ['"Horse! Clip clop clip clop" bouncing them on your knee.', 'Match the bounce to the syllables.'] },
      ...
      { w: 'Yellow', c: 'Colours', ipa: '/ˈjel.əʊ/', say: 'YEL-oh', focus: 'y', why: 'Bright, cheerful, and easy to find in food and toys.', acts: ['Point at a banana or the sun: "yellow!"', 'Gather yellow things: "all yellow!"'] },
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Toes', c: 'Body', ipa: '/təʊz/', say: 'TOHZ', focus: 't', why: 'They can now reach and grab their own feet.', acts: ['Count them: "toes — one, two, three".', 'Wiggle each one as you name it.'] },
      { w: 'Ear', c: 'Body', ipa: '/ɪə/', say: 'EER', focus: 'vowel', why: 'A pure vowel word, easy to stretch out.', acts: ['Whisper into it: "ear — this is your ear".', 'Point to yours, then theirs.'] },
      ...
      { w: 'Hair', c: 'Body', ipa: '/heə/', say: 'HAIR', focus: 'h', why: 'Something they can feel and pull on both of you.', acts: ['Stroke their head: "soft hair".', 'Brush it and name the action too.'] },
      ...
      { w: 'Head', c: 'Body', ipa: '/hed/', say: 'HED', focus: 'h', why: 'Anchors the "head, shoulders, knees and toes" song.', acts: ['Sing the song and touch each part.', 'Slow the song right down.'] },
      ...
      { w: 'No', c: 'Concepts', ipa: '/nəʊ/', say: 'NOH', focus: 'n', why: 'They are beginning to understand it — keep it rare and clear.', acts: ['Use a calm, low, firm tone — not loud.', 'Follow it with what they CAN do.'] },
      { w: 'Wash', c: 'Routine', ipa: '/wɒʃ/', say: 'WOSH', focus: 'w', why: 'A daily action verb with a visible lip shape.', acts: ['"Wash your hands — wash wash wash."', 'Wash a toy together in the bath.'] },
    ],
  },
  ...
  // ===================== 9–11 months: first words ========================
  {
    ...
    words: [
      ...
      { w: 'Car', c: 'Vehicles', ipa: '/kɑː/', say: 'KAH', focus: 'k', why: 'Moving things pull attention and invite sound effects.', acts: ['At the window: "car! Vroom."', 'Push a toy car: "the car goes… car!"'] },
      ...
      { w: 'Door', c: 'World', ipa: '/dɔː/', say: 'DAW', focus: 'd', why: 'A fixed feature of the house, passed through many times a day.', acts: ['"Door — open the door."', 'Knock on it, pause, then open it.'] },
      ...
      { w: 'Open', c: 'Action', ipa: '/ˈəʊ.pən/', say: 'OH-pun', focus: 'p', why: 'A high-utility verb: doors, boxes, books, hands.', acts: ['"Open!" at every door, lid and box.', 'Play open-and-shut with your hands.'] },
      { w: 'Uh-oh', c: 'Social', ipa: '/ˈʌ.əʊ/', say: 'UH-oh', focus: 'vowel', why: 'Playful, easy to say, and highly imitable.', acts: ['Drop a soft toy: "uh-oh!"', 'They will drop things repeatedly — say it every time.'] },
      { w: 'Again', c: 'Concepts', ipa: '/əˈɡen/', say: 'uh-GEN', focus: 'g', why: 'Gives them a way to request more of a good thing.', acts: ['After a tickle, pause: "again?"', 'Wait for a sound or gesture before continuing.'] },
    ],
  },
  {
    m: 10,
    ...
    words: [
      { w: 'Go', c: 'Action', ipa: '/ɡəʊ/', say: 'GOH', focus: 'g', why: 'The shortest, most useful verb there is.', acts: ['"Ready, steady… GO!" — hold the pause.', 'Use it to start every movement game.'] },
      { w: 'Stop', c: 'Action', ipa: '/stɒp/', say: 'STOP', focus: 's', why: 'The pair to "go" — and a genuinely useful safety word.', acts: ['Play stop-and-go while pushing a toy car.', 'Freeze dramatically on "stop".'] },
      ...
      { w: 'Throw', c: 'Action', ipa: '/θrəʊ/', say: 'THROH', focus: 'th', why: 'Models a later sound in a very motivating context.', acts: ['"Ready… throw!" with a soft ball.', 'Do not expect the "th" back for years.'] },
      ...
      { w: 'More', c: 'Action', ipa: '/mɔː/', say: 'MAW', focus: 'm', why: 'A cornerstone word that hands them real control.', acts: ['Stop mid-game: "more?" and wait.', 'Accept any sound or gesture as a "yes".'] },
    ],
  },
  {
    m: 11,
    ...
    words: [
      ...
      { w: 'Chair', c: 'Home', ipa: '/tʃeə/', say: 'CHAIR', focus: 'ch', why: 'Models the "ch" sound on a very familiar object.', acts: ['Pat the seat: "chair — sit on the chair".', 'Count the chairs at the table.'] },
      ...
      { w: 'Bed', c: 'Home', ipa: '/bed/', say: 'BED', focus: 'b', why: 'Anchors the bedtime routine with a single clear word.', acts: ['"Bed time — into bed."', 'Same phrase, same order, every night.'] },
      { w: 'Window', c: 'Home', ipa: '/ˈwɪn.dəʊ/', say: 'WIN-doh', focus: 'w', why: 'A frame for naming everything outside it.', acts: ['"Look out of the window — what can you see?"', 'Name three things through it.'] },
      { w: 'Stairs', c: 'Home', ipa: '/steəz/', say: 'STAIRZ', focus: 's', why: 'A daily, physical, countable feature.', acts: ['Count as you climb: "one, two, three stairs".', 'Say "up the stairs… down the stairs".'] },
      ...
      { w: 'Phone', c: 'Objects', ipa: '/fəʊn/', say: 'FOHN', focus: 'f', why: 'Endlessly interesting to them — use that motivation.', acts: ['Pretend call: "hello? … bye!"', 'Hand it over and take turns talking.'] },
  ...
  // ===================== 12–17 months: single words ======================
  {
    ...
    words: [
      ...
      { w: 'Bread', c: 'Food', ipa: '/bred/', say: 'BRED', focus: 'b', why: 'A daily food with a clear "b" start.', acts: ['"Bread — a piece of bread."', 'Let them tear it while you name it.'] },
  ...
  },
  {
    ...
    words: [
      { w: 'Socks', c: 'Clothes', ipa: '/sɒks/', say: 'SOKS', focus: 's', why: 'Two "s" sounds bracketing a short word.', acts: ['"Socks — on your feet!"', 'Play sock-pulling-off games and name it.'] },
      { w: 'Coat', c: 'Clothes', ipa: '/kəʊt/', say: 'KOHT', focus: 'k', why: 'Signals going out — a very motivating association.', acts: ['"Coat on — we\'re going out!"', 'Hold it up and pause before dressing.'] },
      { w: 'Trousers', c: 'Clothes', ipa: '/ˈtraʊ.zəz/', say: 'TROW-zerz', focus: 't', why: 'A longer word to stretch their syllable handling.', acts: ['"Trousers — one leg, two legs."', 'Count the legs in.'] },
      { w: 'Shirt', c: 'Clothes', ipa: '/ʃɜːt/', say: 'SHURT', focus: 'sh', why: 'Practises "sh" with an over-the-head game.', acts: ['"Where\'s your head? … There it is!" as it pops through.', 'Pause with the shirt over their face.'] },
      ...
      { w: 'Warm', c: 'Concepts', ipa: '/wɔːm/', say: 'WAWM', focus: 'w', why: 'Connects clothing to a felt sensation.', acts: ['"Coat on — now you\'re warm."', 'Contrast with "cold" outside.'] },
      { w: 'Off', c: 'Action', ipa: '/ɒf/', say: 'OFF', focus: 'f', why: 'The natural pair to "on", used constantly while dressing.', acts: ['"Socks off! Hat off!"', 'Alternate "on… off… on".'] },
      { w: 'On', c: 'Action', ipa: '/ɒn/', say: 'ON', focus: 'n', why: 'Tiny, high-frequency and immediately useful.', acts: ['Say it as each item goes on.', 'Pause: "hat… ON!"'] },
      { w: 'Help', c: 'Social', ipa: '/help/', say: 'HELP', focus: 'h', why: 'Gives them a word for frustration before it becomes a meltdown.', acts: ['Model it: "help? Mummy can help."', 'Offer the word when you see them struggle.'] },
    ],
  },
  {
    m: 14,
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Cross', c: 'Feelings', ipa: '/krɒs/', say: 'KROSS', focus: 'k', why: 'Gives anger a name before it becomes a tantrum.', acts: ['"You\'re cross. That was frustrating."', 'Stay calm and keep your tone level.'] },
      { w: 'Tired', c: 'Feelings', ipa: '/ˈtaɪ.əd/', say: 'TY-erd', focus: 't', why: 'Helps them connect a body state to a word.', acts: ['At wind-down: "you\'re tired. Time to rest."', 'Yawn together dramatically.'] },
      { w: 'Scared', c: 'Feelings', ipa: '/skeəd/', say: 'SKAIRD', focus: 'k', why: 'Naming fear reduces it and invites comfort.', acts: ['"That was loud. You felt scared."', 'Hold them while you name it.'] },
      ...
      { w: 'Better', c: 'Feelings', ipa: '/ˈbet.ə/', say: 'BET-er', focus: 'b', why: 'Closes the emotional loop after upset.', acts: ['"All better now."', 'Use it after every comfort.'] },
      { w: 'Okay', c: 'Social', ipa: '/ˌəʊˈkeɪ/', say: 'oh-KAY', focus: 'k', why: 'A reassuring word they will start echoing.', acts: ['"You\'re okay. Mummy\'s here."', 'Use a calm, steady tone.'] },
    ],
    phrases: [
  ...
  },
  {
    ...
    words: [
      { w: 'Red', c: 'Colours', ipa: '/red/', say: 'RED', focus: 'r', why: 'Usually the first colour word children produce.', acts: ['Find five red things: "red cup… red sock… red car".', 'Stress "red" each time, not the object.'] },
      ...
      { w: 'Orange', c: 'Colours', ipa: '/ˈɒr.ɪndʒ/', say: 'OR-inj', focus: 'j', why: 'A colour and a fruit — two meanings, one word.', acts: ['Hold an orange: "orange — it\'s orange!"', 'Find other orange things together.'] },
      { w: 'Purple', c: 'Colours', ipa: '/ˈpɜː.pəl/', say: 'PUR-pul', focus: 'p', why: 'Two "p" sounds and a satisfying rhythm.', acts: ['Point at grapes or flowers: "purple".', 'Sort purple things into a box.'] },
      ...
      { w: 'Circle', c: 'Shapes', ipa: '/ˈsɜː.kəl/', say: 'SUR-kul', focus: 's', why: 'The first shape most toddlers recognise.', acts: ['Trace it in the air: "circle — round and round".', 'Find circles: plates, wheels, the moon.'] },
      { w: 'Square', c: 'Shapes', ipa: '/skweə/', say: 'SKWAIR', focus: 's', why: 'Corners make it easy to feel as well as see.', acts: ['Trace the four sides on a book.', 'Count the sides: "one, two, three, four".'] },
      { w: 'Star', c: 'Shapes', ipa: '/stɑː/', say: 'STAH', focus: 's', why: 'Tied to a song they almost certainly know.', acts: ['Sing "Twinkle Twinkle" and point up.', 'Find star shapes on clothes and in books.'] },
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Soap', c: 'Routine', ipa: '/səʊp/', say: 'SOHP', focus: 's', why: 'A daily object with a clean "s" onset.', acts: ['"Soap — slippery soap!"', 'Let them hold it and lose it.'] },
      { w: 'Wet', c: 'Concepts', ipa: '/wet/', say: 'WET', focus: 'w', why: 'A felt sensation paired with a short word.', acts: ['"You\'re wet! Now let\'s get dry."', 'Contrast wet and dry with a towel.'] },
      ...
      { w: 'Story', c: 'Routine', ipa: '/ˈstɔː.ri/', say: 'STAW-ree', focus: 's', why: 'Names the ritual that builds every later language skill.', acts: ['"Story time! Which story?"', 'Let them choose between two books.'] },
  ...
  // ===================== 18–23 months: word combos =======================
  {
    ...
    words: [
      ...
      { w: 'Wash', c: 'Action', ipa: '/wɒʃ/', say: 'WOSH', focus: 'w', why: 'A routine verb with a visible lip shape.', acts: ['"Wash hands. Wash the cup."', 'Swap the object each time.'] },
      ...
      { w: 'Help', c: 'Action', ipa: '/help/', say: 'HELP', focus: 'h', why: 'Turns frustration into communication.', acts: ['"Do you need help? Say help."', 'Respond instantly when they use it.'] },
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Fast', c: 'Concepts', ipa: '/fɑːst/', say: 'FAST', focus: 'f', why: 'Felt in the body during movement games.', acts: ['Run fast, then say it: "fast!"', 'Push a car quickly and slowly.'] },
      { w: 'Slow', c: 'Concepts', ipa: '/sləʊ/', say: 'SLOH', focus: 's', why: 'Stretch the word out to match the meaning.', acts: ['"Slooooow" in a low, drawn-out voice.', 'Walk in slow motion together.'] },
      ...
      { w: 'Empty', c: 'Concepts', ipa: '/ˈemp.ti/', say: 'EMP-tee', focus: 'm', why: 'Demonstrable with any cup or box.', acts: ['Tip a cup over: "empty! All gone."', 'Fill it again: "full".'] },
      ...
      { w: 'Dirty', c: 'Concepts', ipa: '/ˈdɜː.ti/', say: 'DUR-tee', focus: 'd', why: 'A concept they generate plenty of evidence for.', acts: ['"Dirty hands! Let\'s wash them."', 'Then: "clean hands!"'] },
  ...
  },
  {
    ...
    words: [
      { w: 'Flower', c: 'Nature', ipa: '/ˈflaʊ.ə/', say: 'FLOW-er', focus: 'f', why: 'Smellable, touchable and colourful all at once.', acts: ['Smell one: "flower — mmm!"', 'Name the colour too.'] },
      ...
      { w: 'Grass', c: 'Nature', ipa: '/ɡrɑːs/', say: 'GRASS', focus: 'g', why: 'A texture they can feel with hands and feet.', acts: ['Bare feet on grass: "grass — tickly!"', 'Name the colour: "green grass".'] },
      ...
      { w: 'Snow', c: 'Weather', ipa: '/snəʊ/', say: 'SNOH', focus: 's', why: 'Rare and magical, so highly memorable.', acts: ['"Snow! Cold snow."', 'Catch a flake and name it.'] },
      ...
      { w: 'Water', c: 'Nature', ipa: '/ˈwɔː.tə/', say: 'WAW-ter', focus: 'w', why: 'Appears in the bath, the sink, the rain and the sea.', acts: ['Name it in four different places today.', 'Pour it and narrate.'] },
      { w: 'Stone', c: 'Nature', ipa: '/stəʊn/', say: 'STOHN', focus: 's', why: 'Heavy, hard and collectable.', acts: ['"Stone — heavy stone."', 'Drop one in a puddle: "splash!"'] },
      { w: 'Butterfly', c: 'Nature', ipa: '/ˈbʌt.ə.flaɪ/', say: 'BUT-er-fly', focus: 'b', why: 'Three syllables and a sense of wonder.', acts: ['"Butterfly! It flies."', 'Clap the three syllables.'] },
      { w: 'Garden', c: 'World', ipa: '/ˈɡɑː.dən/', say: 'GAH-dun', focus: 'g', why: 'Names the place where all these words live.', acts: ['"Let\'s go in the garden."', 'Name three things in it each visit.'] },
    ],
    phrases: [
  ...
  },
  {
    ...
    words: [
      { w: 'Blocks', c: 'Toys', ipa: '/blɒks/', say: 'BLOKS', focus: 'b', why: 'Countable, stackable and endlessly re-nameable.', acts: ['"Blocks — build a tower."', 'Count them as you stack.'] },
      { w: 'Doll', c: 'Toys', ipa: '/dɒl/', say: 'DOL', focus: 'd', why: 'A character to talk about and talk to.', acts: ['"The doll is hungry. Feed the doll."', 'Give the doll a voice.'] },
      ...
      { w: 'Turn', c: 'Social', ipa: '/tɜːn/', say: 'TURN', focus: 't', why: 'The word that makes shared play possible.', acts: ['"My turn… your turn."', 'Keep the turns short at first.'] },
    ],
    phrases: [
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'On', c: 'Position', ipa: '/ɒn/', say: 'ON', focus: 'n', why: 'Tiny and used dozens of times a day.', acts: ['"On the table. On your head!"', 'Be silly with the placements.'] },
      { w: 'Under', c: 'Position', ipa: '/ˈʌn.də/', say: 'UN-der', focus: 'd', why: 'Powers hide-and-seek and searching games.', acts: ['Hide a toy: "it\'s UNDER the blanket!"', 'Ask them to find it.'] },
      ...
      { w: 'Next to', c: 'Position', ipa: '/ˈnekst tuː/', say: 'NEKST-too', focus: 'n', why: 'Introduces relative position between two things.', acts: ['"The cup is next to the plate."', 'Arrange toys in a row.'] },
      { w: 'Top', c: 'Position', ipa: '/tɒp/', say: 'TOP', focus: 't', why: 'Useful for towers, stairs and shelves.', acts: ['"On top! Right at the top."', 'Stack blocks and name the top one.'] },
      ...
      { w: 'Here', c: 'Position', ipa: '/hɪə/', say: 'HEER', focus: 'h', why: 'Constantly useful and easy to gesture.', acts: ['Pat the spot: "here! Come here."', 'Contrast with "there".'] },
    ],
    phrases: [
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Four', c: 'Numbers', ipa: '/fɔː/', say: 'FAW', focus: 'f', why: 'Extends the counting rhythm one further.', acts: ['Count four wheels on a toy car.', 'Touch each one as you count.'] },
      ...
      { w: 'More', c: 'Numbers', ipa: '/mɔː/', say: 'MAW', focus: 'm', why: 'The earliest and most useful quantity word.', acts: ['"More? One more."', 'Combine: "more grapes".'] },
      { w: 'Lots', c: 'Numbers', ipa: '/lɒts/', say: 'LOTS', focus: 'l', why: 'A quantity word that needs no exact counting.', acts: ['"Lots of bubbles!"', 'Contrast with "one".'] },
      ...
      { w: 'Again', c: 'Concepts', ipa: '/əˈɡen/', say: 'uh-GEN', focus: 'g', why: 'Lets them request a repeat with words.', acts: ['Pause after a game: "again?"', 'Wait for the word before repeating.'] },
      { w: 'Last', c: 'Concepts', ipa: '/lɑːst/', say: 'LAST', focus: 'l', why: 'Prepares them for transitions and endings.', acts: ['"One more, then it\'s the last one."', 'Follow through consistently.'] },
    ],
    phrases: [
  ...
  // ===================== 24–36 months: sentences =========================
  {
    ...
    words: [
      ...
      { w: 'Want', c: 'Action', ipa: '/wɒnt/', say: 'WONT', focus: 'w', why: 'Turns demands into sentences.', acts: ['"I want juice. What do you want?"', 'Model the whole sentence.'] },
      { w: 'Go', c: 'Action', ipa: '/ɡəʊ/', say: 'GOH', focus: 'g', why: 'Combines with almost any noun or place.', acts: ['"I go outside. We go now."', 'Vary who is going.'] },
      ...
      { w: 'Ours', c: 'Language', ipa: '/ˈaʊ.əz/', say: 'OW-erz', focus: 'vowel', why: 'Introduces shared possession — a step past "mine".', acts: ['"This is ours. We share it."', 'Use during shared play.'] },
  ...
  },
  {
    ...
    words: [
      { w: 'Elephant', c: 'Animals', ipa: '/ˈel.ə.fənt/', say: 'EL-uh-funt', focus: 'f', why: 'Three syllables stretches their word length.', acts: ['"Elephant! Big grey elephant."', 'Clap the three syllables.'] },
      ...
      { w: 'Frog', c: 'Animals', ipa: '/frɒɡ/', say: 'FROG', focus: 'f', why: 'A consonant cluster plus a jumping game.', acts: ['"Frog — ribbit! Jump like a frog."', 'Jump on each "ribbit".'] },
      ...
      { w: 'Horse', c: 'Animals', ipa: '/hɔːs/', say: 'HAWSS', focus: 'h', why: 'Rhythmic clip-clop supports speech timing.', acts: ['Bounce on your knee: "clip clop".', 'Match the bounce to the beat.'] },
      ...
      { w: 'Farm', c: 'World', ipa: '/fɑːm/', say: 'FAHM', focus: 'f', why: 'The category label that ties the group together.', acts: ['"Farm animals: cow, pig, sheep."', 'Sort toy animals into farm and wild.'] },
    ],
    phrases: [
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Fork', c: 'Objects', ipa: '/fɔːk/', say: 'FAWK', focus: 'f', why: 'A tool they are learning to control.', acts: ['"Fork — stab the pasta!"', 'Name it every meal.'] },
      { w: 'Bowl', c: 'Objects', ipa: '/bəʊl/', say: 'BOHL', focus: 'b', why: 'Contrasts nicely with "plate".', acts: ['"Bowl for soup, plate for toast."', 'Sort them together.'] },
      { w: 'Pasta', c: 'Food', ipa: '/ˈpæs.tə/', say: 'PASS-tuh', focus: 'p', why: 'A favourite, so motivation is high.', acts: ['"Pasta! Yummy pasta."', 'Let them help stir.'] },
      { w: 'Egg', c: 'Food', ipa: '/eɡ/', say: 'EG', focus: 'g', why: 'Short, clear and full of process to narrate.', acts: ['Crack one: "egg — crack!"', 'Whisk together.'] },
      { w: 'Toast', c: 'Food', ipa: '/təʊst/', say: 'TOHST', focus: 't', why: 'A daily breakfast word with a pop-up event.', acts: ['"Toast — pop!" when it jumps up.', 'Wait for the pop together.'] },
      ...
      { w: 'Thirsty', c: 'Feelings', ipa: '/ˈθɜː.sti/', say: 'THUR-stee', focus: 'th', why: 'Models "th" in a genuinely useful word.', acts: ['"Thirsty? Here\'s some water."', 'Offer the word when they reach for a cup.'] },
      { w: 'Stir', c: 'Action', ipa: '/stɜː/', say: 'STUR', focus: 's', why: 'A cooking verb they can actually perform.', acts: ['"Stir it round and round."', 'Hand over hand together.'] },
      { w: 'Pour', c: 'Action', ipa: '/pɔː/', say: 'PAW', focus: 'p', why: 'A satisfying action with visible cause and effect.', acts: ['"Pour the milk — slowly!"', 'Let them try with a small jug.'] },
    ],
    phrases: [
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Sorry', c: 'Manners', ipa: '/ˈsɒr.i/', say: 'SOR-ee', focus: 's', why: 'Model it genuinely, including when you get it wrong.', acts: ['Say sorry to them when you snap.', 'Never force it out of them.'] },
      { w: 'Gentle', c: 'Manners', ipa: '/ˈdʒen.təl/', say: 'JEN-tul', focus: 'j', why: 'Essential for pets, babies and friends.', acts: ['"Gentle hands with the cat."', 'Praise it the moment it happens.'] },
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Rectangle', c: 'Shapes', ipa: '/ˈrek.tæŋ.ɡəl/', say: 'REK-tang-gul', focus: 'r', why: 'A long word for a very common shape.', acts: ['"A door is a rectangle."', 'Clap the syllables.'] },
      ...
      { w: 'Sort', c: 'Action', ipa: '/sɔːt/', say: 'SAWT', focus: 's', why: 'Names the activity itself.', acts: ['"Let\'s sort the blocks by colour."', 'State the rule out loud.'] },
      { w: 'Long', c: 'Concepts', ipa: '/lɒŋ/', say: 'LONG', focus: 'ng', why: 'A size word beyond big and small.', acts: ['"A long snake! A short worm."', 'Stretch your arms out.'] },
      { w: 'Short', c: 'Concepts', ipa: '/ʃɔːt/', say: 'SHAWT', focus: 'sh', why: 'Partner to "long", with a clear "sh".', acts: ['Compare two sticks: "long… short".', 'Line them up side by side.'] },
      { w: 'Heavy', c: 'Concepts', ipa: '/ˈhev.i/', say: 'HEV-ee', focus: 'h', why: 'A property they feel with their whole body.', acts: ['Lift something: "heavy! Ooof."', 'Contrast with something light.'] },
  ...
  },
  {
    ...
    words: [
      { w: 'First', c: 'Time', ipa: '/fɜːst/', say: 'FURST', focus: 'f', why: 'Opens every sequence instruction.', acts: ['"First shoes, then park."', 'Use the same phrasing every time.'] },
      { w: 'Then', c: 'Time', ipa: '/ðen/', say: 'THEN', focus: 'th', why: 'Links two events into an order.', acts: ['"Bath, then story, then bed."', 'Count the steps on your fingers.'] },
      { w: 'Next', c: 'Time', ipa: '/nekst/', say: 'NEKST', focus: 'n', why: 'Helps them predict what is coming.', acts: ['"What comes next?"', 'Let them answer.'] },
      { w: 'Now', c: 'Time', ipa: '/naʊ/', say: 'NOW', focus: 'n', why: 'The anchor point for all other time words.', acts: ['"Not later — now!"', 'Contrast with "soon".'] },
      { w: 'Later', c: 'Time', ipa: '/ˈleɪ.tə/', say: 'LAY-ter', focus: 'l', why: 'Introduces delay, and with it patience.', acts: ['"We\'ll do it later, after lunch."', 'Always follow through.'] },
      ...
      { w: 'Tomorrow', c: 'Time', ipa: '/təˈmɒr.əʊ/', say: 'tuh-MOR-oh', focus: 'm', why: 'A three-syllable word for the future.', acts: ['"Tomorrow, after sleep."', 'Link it to waking up.'] },
      { w: 'Morning', c: 'Time', ipa: '/ˈmɔː.nɪŋ/', say: 'MAW-ning', focus: 'ng', why: 'Ties a time word to a felt part of the day.', acts: ['"Good morning! It\'s morning time."', 'Same greeting every day.'] },
  ...
  },
  {
    ...
    techniques: ['expand', 'joint', 'ids'],
    words: [
      { w: 'Share', c: 'Manners', ipa: '/ʃeə/', say: 'SHAIR', focus: 'sh', why: 'The central social skill of this age.', acts: ['"I\'ll share my snack with you."', 'Praise sharing the instant it happens.'] },
      { w: 'Friend', c: 'People', ipa: '/frend/', say: 'FREND', focus: 'f', why: 'Names the relationship they are forming.', acts: ['"Your friend Sam is here."', 'Use children\'s names often.'] },
      ...
      { w: 'Together', c: 'Social', ipa: '/təˈɡeð.ə/', say: 'tuh-GETH-er', focus: 'th', why: 'Three syllables and a warm, cooperative idea.', acts: ['"Let\'s build it together!"', 'Sing "the more we get together".'] },
      { w: 'Swap', c: 'Social', ipa: '/swɒp/', say: 'SWOP', focus: 's', why: 'A practical alternative to a tug-of-war.', acts: ['"Shall we swap? You have this one."', 'Offer a swap before conflict escalates.'] },
      { w: 'Ask', c: 'Social', ipa: '/ɑːsk/', say: 'ASK', focus: 's', why: 'Replaces grabbing with words.', acts: ['"Ask him: can I have it?"', 'Give them the exact words.'] },
      { w: 'Hello', c: 'Social', ipa: '/həˈləʊ/', say: 'huh-LOH', focus: 'h', why: 'Greeting others is a skill worth rehearsing.', acts: ['Practise before you arrive somewhere.', 'Model it warmly every time.'] },
      ...
      { w: 'Sorry', c: 'Manners', ipa: '/ˈsɒr.i/', say: 'SOR-ee', focus: 's', why: 'Best taught by example, not enforcement.', acts: ['Model it yourself, genuinely.', 'Explain what it means.'] },
      { w: 'Everyone', c: 'People', ipa: '/ˈev.ri.wʌn/', say: 'EV-ree-wun', focus: 'w', why: 'A group word for a growing social world.', acts: ['"Everyone gets a turn."', 'Point to each person as you say it.'] },
    ],
    phrases: [
  ...
  },
  {
    ...
    techniques: ['expand', 'joint', 'varied'],
    words: [
      { w: 'What', c: 'Language', ipa: '/wɒt/', say: 'WOT', focus: 'w', why: 'The most useful question word of all.', acts: ['"What is that? What can you see?"', 'Pause and genuinely wait.'] },
      { w: 'Where', c: 'Language', ipa: '/weə/', say: 'WAIR', focus: 'w', why: 'Powers searching and hiding games.', acts: ['"Where is teddy? Let\'s look."', 'Search together, narrating.'] },
      ...
      { w: 'When', c: 'Language', ipa: '/wen/', say: 'WEN', focus: 'w', why: 'Connects questions to time words.', acts: ['"When we get home, we\'ll eat."', 'Answer with a routine anchor.'] },
      ...
      { w: 'Know', c: 'Language', ipa: '/nəʊ/', say: 'NOH', focus: 'n', why: 'Distinguishes knowing from guessing.', acts: ['"I know! It\'s under the chair."', 'Admit when you do not know.'] },
    ],
    phrases: [
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Finger', c: 'Body', ipa: '/ˈfɪŋ.ɡə/', say: 'FING-ger', focus: 'ng', why: 'Countable, and involved in most small injuries.', acts: ['Count all ten: "fingers!"', 'Name each one.'] },
      { w: 'Elbow', c: 'Body', ipa: '/ˈel.bəʊ/', say: 'EL-boh', focus: 'l', why: 'A less obvious part worth naming.', acts: ['Touch elbows: "elbow!"', 'Play a body-part touching game.'] },
      { w: 'Shoulder', c: 'Body', ipa: '/ˈʃəʊl.də/', say: 'SHOHL-der', focus: 'sh', why: 'Features in a song they already know.', acts: ['Sing "head, shoulders, knees and toes".', 'Slow it right down.'] },
      ...
      { w: 'Hurt', c: 'Feelings', ipa: '/hɜːt/', say: 'HURT', focus: 'h', why: 'The word that lets them tell you something is wrong.', acts: ['"Does it hurt? Show me where."', 'Take it seriously every time.'] },
      { w: 'Poorly', c: 'Feelings', ipa: '/ˈpɔː.li/', say: 'PAW-lee', focus: 'p', why: 'A general word for feeling unwell.', acts: ['"You feel poorly. Let\'s rest."', 'Use it with a gentle tone.'] },
      { w: 'Medicine', c: 'Objects', ipa: '/ˈmed.sən/', say: 'MED-sin', focus: 'm', why: 'Naming it in advance reduces the fear.', acts: ['"Medicine helps you feel better."', 'Explain before you give it.'] },
      { w: 'Doctor', c: 'People', ipa: '/ˈdɒk.tə/', say: 'DOK-ter', focus: 'd', why: 'Preparing for visits makes them go better.', acts: ['Play doctors with teddy.', 'Explain what will happen first.'] },
      { w: 'Rest', c: 'Action', ipa: '/rest/', say: 'REST', focus: 'r', why: 'Names the thing they need when unwell.', acts: ['"Let\'s rest on the sofa."', 'Make it cosy and named.'] },
    ],
    phrases: [
  ...
  },
  {
    ...
    words: [
      { w: 'Shop', c: 'World', ipa: '/ʃɒp/', say: 'SHOP', focus: 'sh', why: 'A weekly destination full of nameable things.', acts: ['"We\'re going to the shop."', 'Name three things you buy.'] },
      { w: 'Park', c: 'World', ipa: '/pɑːk/', say: 'PAHK', focus: 'p', why: 'A much-loved place, so highly motivating.', acts: ['"To the park! What shall we play on?"', 'Name the equipment.'] },
      ...
      { w: 'Hospital', c: 'World', ipa: '/ˈhɒs.pɪ.təl/', say: 'HOS-pi-tul', focus: 'h', why: 'Three syllables and a place worth demystifying.', acts: ['"Doctors work at the hospital."', 'Keep the tone matter-of-fact.'] },
      { w: 'Library', c: 'World', ipa: '/ˈlaɪ.brə.ri/', say: 'LY-bruh-ree', focus: 'l', why: 'Ties place, books and quiet together.', acts: ['"The library is full of books."', 'Let them choose one.'] },
      { w: 'Doctor', c: 'People', ipa: '/ˈdɒk.tə/', say: 'DOK-ter', focus: 'd', why: 'A role they will meet regularly.', acts: ['"The doctor helps people."', 'Play the role together.'] },
      { w: 'Driver', c: 'People', ipa: '/ˈdraɪ.və/', say: 'DRY-ver', focus: 'd', why: 'Links a person to an action they can see.', acts: ['"The driver drives the bus."', 'Wave at the driver.'] },
      { w: 'Postman', c: 'People', ipa: '/ˈpəʊst.mən/', say: 'POHST-mun', focus: 'p', why: 'A visible daily visitor.', acts: ['"The postman brings letters."', 'Watch for the post together.'] },
      { w: 'Neighbour', c: 'People', ipa: '/ˈneɪ.bə/', say: 'NAY-ber', focus: 'n', why: 'Names the people nearest to home.', acts: ['"That\'s our neighbour. Say hello!"', 'Use their actual name too.'] },
  ...
  },
  {
    ...
    words: [
      { w: 'Soft', c: 'Concepts', ipa: '/sɒft/', say: 'SOFT', focus: 's', why: 'A texture they can verify by touch instantly.', acts: ['"Soft blanket. Feel it."', 'Contrast with something hard.'] },
      ...
      { w: 'Sour', c: 'Concepts', ipa: '/ˈsaʊ.ə/', say: 'SOW-er', focus: 's', why: 'Produces a memorable face.', acts: ['Try a lemon: "sour!"', 'Pull the face together.'] },
      ...
      { w: 'Dark', c: 'Concepts', ipa: '/dɑːk/', say: 'DAHK', focus: 'd', why: 'Useful for bedtime and for feelings about it.', acts: ['"It\'s dark outside now."', 'Turn a light off and on.'] },
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'Clothes', c: 'Categories', ipa: '/kləʊz/', say: 'KLOHZ', focus: 'k', why: 'A category they handle twice a day.', acts: ['"Socks, coat, hat — all clothes."', 'Sort the laundry together.'] },
      ...
      { w: 'Furniture', c: 'Categories', ipa: '/ˈfɜː.nɪ.tʃə/', say: 'FUR-ni-cher', focus: 'ch', why: 'A long word for very familiar objects.', acts: ['"Chair, table, bed — furniture."', 'Walk round naming it.'] },
      ...
      { w: 'Colours', c: 'Categories', ipa: '/ˈkʌl.əz/', say: 'KUL-erz', focus: 'k', why: 'Naming the category consolidates the members.', acts: ['"Red, blue, green — all colours."', 'Sort crayons.'] },
      { w: 'Vegetables', c: 'Categories', ipa: '/ˈvedʒ.tə.bəlz/', say: 'VEJ-tuh-bulz', focus: 'v', why: 'A long word, and useful at every mealtime.', acts: ['"Carrot and peas are vegetables."', 'Name them as you cook.'] },
      { w: 'Belong', c: 'Concepts', ipa: '/bɪˈlɒŋ/', say: 'bee-LONG', focus: 'ng', why: 'Names the idea of membership itself.', acts: ['"Where does this belong?"', 'Use it during tidy-up.'] },
    ],
    phrases: [
  ...
  },
  {
    ...
    words: [
      ...
      { w: 'So', c: 'Language', ipa: '/səʊ/', say: 'SOH', focus: 's', why: 'Expresses consequence and result.', acts: ['"It was cold, so we wore coats."', 'Pair it with "because".'] },
      { w: 'After', c: 'Time', ipa: '/ˈɑːf.tə/', say: 'AHF-ter', focus: 'f', why: 'Sequences events within a story.', acts: ['"After lunch, we played."', 'Retell the day in order.'] },
      { w: 'Before', c: 'Time', ipa: '/bɪˈfɔː/', say: 'bee-FAW', focus: 'b', why: 'The harder half of the sequencing pair.', acts: ['"Before bed, we read a story."', 'Use it in the bedtime routine.'] },
      { w: 'Remember', c: 'Language', ipa: '/rɪˈmem.bə/', say: 're-MEM-ber', focus: 'r', why: 'Names the act of recalling the past.', acts: ['"Do you remember the beach?"', 'Look at photos and recall together.'] },
      { w: 'Story', c: 'Language', ipa: '/ˈstɔː.ri/', say: 'STAW-ree', focus: 's', why: 'Names what they are learning to make.', acts: ['"Tell me a story about your day."', 'Let them lead, however odd it gets.'] },
      { w: 'Pretend', c: 'Play', ipa: '/prɪˈtend/', say: 'pre-TEND', focus: 'p', why: 'Names imaginative play explicitly.', acts: ['"Let\'s pretend to be lions!"', 'Follow their imaginary rules.'] },
      ...
      { w: 'End', c: 'Language', ipa: '/end/', say: 'END', focus: 'n', why: 'Closes a story and marks completion.', acts: ['"…and that\'s the end!"', 'Clap at the end of every story.'] },
    ],
    phrases: [
